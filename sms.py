...
class SendSms():
    ...
    def Dsmartgo(self):
        ...
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ dsmartgo.com.tr")
        except AttributeError:
            print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ dsmartgo.com.tr")
            self.adet += 1
    ...
    def Kigili(self):    
        try:
            ...
            if kigili.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ kigili.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ kigili.com")
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ core.kahvedunyasi.com")
    ...
    def NaosStars(self):
        try:
            ...
            if naosstars.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ shop.naosstars.com")
                self.adet += 1 
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ shop.naosstars.com")
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ wmf.com.tr")
    ...
    def IsteGelsin(self):
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ prod.fasapi.net")
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ bim.veesk.net")
    ...
    def Sok(self):
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.ceptesok.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.ceptesok.com")
    ...
    def Tiklagelsin(self):
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ svc.apps.tiklagelsin.com")
    ...
    def Migros(self):
        try:
            ...
            if migros.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ rest.migros.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ rest.migros.com.tr")
    ...
    def A101(self):
        try:
            ...
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ a101.com.tr")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ a101.com.tr")
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ englishhome.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ englishhome.com")
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ sakasu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ sakasu.com.tr")
    ...
    def Rentiva(self): 
        try:
            ...
            if rentiva.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ rentiva.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ rentiva.com")
    ...
    def Bineq(self):
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ bineqapi.heymobility.tech")
    ...
    def Link(self):
        try:
            ...
            if link.json()["detail"] == "Ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ consumer-auth.linkfleet.de")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ consumer-auth.linkfleet.de")
    ...
    def Lonca(self):
        try:
            ...
            if lonca.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ loncamarket.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ loncamarket.com")   
    ...
    def Dgn(self):
        try:
            ...
            if dgn.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ odeme.dgnonline.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ odeme.dgnonline.com")  
    ...
    def Yaani(self):
        try:
            ...
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.yaanimail.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.yaanimail.com")  
    ...
    def Defacto(self):
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ defacto.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ defacto.com.tr")
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mopas.com.tr")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ u.icq.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ u.icq.net")
    ...
    def Boyner(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ boyner.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ boyner.com")
    ...
    def Watsons(self):
        try:
            ...
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ watsons.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ watsons.com.tr")
    ...
    def Buyur(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ app.buyursungelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ app.buyursungelsin.com")
    ...
    def Osmanlideal(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ osmgck.idealdata.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ osmgck.idealdata.com.tr")
    ...
    def Pinar(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ pinarsumobileservice.yasar.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ pinarsumobileservice.yasar.com.tr")
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ suiste.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ suiste.com")
    ...
    def Hayat(self):
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ hayatsu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ hayatsu.com.tr")
    ...
    def Pisir(self):
        try:
            ...
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.pisir.com")
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def IkinciYeni(self):
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ apigw.ikinciyeni.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ apigw.ikinciyeni.com")
    ...
    def Terra(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if (r.status_code) == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.terrapizza.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.terrapizza.com.tr")
    ...
    def IpraGaz(self):
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ ipapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ ipapp.ipragaz.com.tr")
    ...
    def Mogaz(self):
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mogazmobilapinew.aygaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mogazmobilapinew.aygaz.com.tr")
    ...
    def GoMobile(self):
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ gomobilapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ gomobilapp.ipragaz.com.tr")
    ...
    def PetrolOfisi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mobilapi.petrolofisi.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mobilapi.petrolofisi.com.tr")
    ...
    def Total(self):
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mobileapi.totalistasyonlari.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mobileapi.totalistasyonlari.com.tr")
    ...
    def Opet(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.opet.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.opet.com.tr")
    ...
    def Dolap(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api-gateway.dolap.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api-gateway.dolap.com")
    ...
    def Hey(self):
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ heyapi.heymobility.tech")
    ...
    def Tazi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mobileapiv2.tazi.tech")
    ...
    def Isbike(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["sonuc"]["aciklama"]) == "İşlem API Başarılı!":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ app.isbike.istanbul")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ app.isbike.istanbul")
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mobileapi.n11.com")
    ...
    def Joker(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ joker.com.tr")
    ...
    def Ebebek(self):
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api2.e-bebek.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api2.e-bebek.com")
    ...
    def Saka(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["status"]) == 1 :
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ mobilcrm2.saka.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ mobilcrm2.saka.com.tr")
    ...
    def Gofody(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ backend.gofody.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ backend.gofody.com")
    ...
    def Madame(self):
        try:
            ...
            if (r.status_code) == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ madamecoco.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ madamecoco.com")
    ...
    def Buludag(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ bilet.balikesiruludag.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ bilet.balikesiruludag.com.tr")   
    ...
    def Evidea(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)      
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ evidea.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ evidea.com")
    ...
    def Koctas(self):
        try:
            ...
            if (r.json()["status"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ occ2.koctas.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ occ2.koctas.com.tr")
    ...
    def Gratis(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ ivt.mobildev.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ ivt.mobildev.com")
    ...
    def Anadolu(self):
        try:
            ...
            r = requests.get(url)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ anadolu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ anadolu.com.tr")
    ...
    def Accordors(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["data"]:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ aouws.accordors.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ aouws.accordors.com")
    ...
    def Marti(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ customer.martiscooter.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ customer.martiscooter.com")
    ...
    def Hop(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.hoplagit.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.hoplagit.com")
    ...
    def Karma(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı!! {self.phone} ➜ api.gokarma.app")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! {self.phone} ➜ api.gokarma.app")
